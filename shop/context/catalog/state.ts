...
import { catalog, setCatalogCategoryOptions, setSizesOptions, setSizesOptionByCheck, updateSizesOptionBySize, setColorsOptions, updateColorsOptionByCode, setSizes, setColors, setFiltersPopup } from "."
...
export const $filtersPopup = catalog.createStore(false)
