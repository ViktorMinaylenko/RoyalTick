...
const ProfileName = () => {
    ...
    const nameRegister = register(
        'name',
        nameValidationRules('Недопустиме значення!', `Введіть ім'я`)
    )
    ...
    if (!isClient) {
        return (
            <div className={styles.profile__info} style={{ minHeight: '30px' }}>
                <div className={styles.profile__info__text}>Loading...</div>
            </div>
        )
    }
