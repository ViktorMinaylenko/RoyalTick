...
import { generateTokens, getAuthRouteData, parseJwt } from '@/lib/utils/api-routes'
...
export async function PATCH(req: Request) {
    try {
        ...
        await db.collection('users').updateOne({ _id: new ObjectId(user?._id) }, { $set: { email: reqBody.email }, })
